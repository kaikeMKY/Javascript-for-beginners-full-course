...
null is nonexistional 
boolean is true or false
string is a text and a number is a number baka
...
exemples:*/
var fumoPlushie = "something";
//the variables can be changed
var fumoPlushie = 1;

var reimu; //we declare reimu
console.log(reimu); //reimu is null
var cirno = 9; // we declare cirno and assign an value
reimu = 1; //we assign reimu
cirno = reimu; //now cirno has the same contain of reimu
console.log(reimu); //i should show me some value but im on the vs code so idk that a shame
...
// ex: Cirno é diferente de cirNO tem que ser igual
